...
import { Loader2, HelpCircle, RefreshCw, Star, Trophy, X, Check, Timer, Coins, ShieldHalf, BrainCircuit } from "lucide-react";
...
function QuizBoltGameContent() {
    ...
    const useLifeline = (lifeline: Lifeline) => {
        ...
        if (lifeline === 'fiftyFifty') {
            ...
            newQuestions[currentQuestionIndex].options = currentQuestion.options.filter(opt => !optionsToRemove.includes(opt));
                    ...
                    <div className="flex justify-between items-center">
                        <div className="w-24 text-left">
                            <Dialog open={isQuitConfirmOpen} onOpenChange={setIsQuitConfirmOpen}>
                                <DialogTrigger asChild><Button variant="destructive" size="sm">Quit</Button></DialogTrigger>
                         ...
                         <div className="relative w-24 h-24 flex items-center justify-center">
                            <Progress value={(timeLeft / 60) * 100} className="absolute w-full h-full [&>div]:bg-yellow-400" />
                            ...
                            return (
                                <Button
                                    ...
                                    className={cn(
                                        ...
                                        isSelected && "border-yellow-400 bg-yellow-900/50",
...
export default function QuizBoltGamePage() {
    return (
        <ProtectedRoute>
            <QuizBoltGameContent/>
        </ProtectedRoute>
