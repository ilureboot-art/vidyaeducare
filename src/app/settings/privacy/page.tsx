    ...
    <div className="w-full max-w-2xl mx-auto">
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-4">
          <p>Your privacy is important to us. It is Vidya EduCare's policy to respect your privacy regarding any information we may collect from you through our app.</p>
