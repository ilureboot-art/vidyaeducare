    ...
    <div className="w-full max-w-2xl mx-auto">
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-4">
            <p>Welcome to NumberAce! These terms and conditions outline the rules and regulations for the use of our application.</p>
            
            <h2 className="text-xl font-semibold">1. Introduction</h2>
            <p>By accessing this app, we assume you accept these terms and conditions. Do not continue to use NumberAce if you do not agree to all of the terms and conditions stated on this page.</p>

            <h2 className="text-xl font-semibold">2. License</h2>
            <p>Unless otherwise stated, NumberAce and/or its licensors own the intellectual property rights for all material on NumberAce. All intellectual property rights are reserved.</p>
            ...
            <p>You grant to NumberAce a worldwide, irrevocable, non-exclusive, royalty-free license to use, reproduce, adapt, publish, translate and distribute your user content in any existing or future media.</p>
